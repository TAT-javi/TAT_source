...
$query = "select Timestamp,RA,Declination from Shift where Timestamp >$start and R >= 0.2 order by id";
...
mysql_close($conn);
//include these 2 lines to print the last data on the graph
$ra[$k]=0;
$dec[$k]=0;
$k--;
...
if($k<2)
{
	$ra=array(0,0,0);
	$dec = array(0,0,0);
	$T="No recent data for $night";
}
else
{
	$T="Shifts on RA and DEC for $night";
}
// Create the graph. These two calls are always required
$graph = new Graph(640,150,"auto");	
